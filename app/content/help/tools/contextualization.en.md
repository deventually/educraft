...
Contextualization helps you **make the teaching philosophy behind your course explicit**. Use it when you want to check whether your learning outcomes, methods, and assessment truly line up — and whether students understand *why* you designed it that way.

## How it works

It's a **one-shot generator**. You paste your course outline, learning outcomes, and your own pedagogical approach; the tool names the implicit philosophy, runs an alignment check, describes the student perspective, and gives recommendations to close gaps.
