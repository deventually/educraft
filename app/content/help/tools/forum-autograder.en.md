...
Forum Autograder helps you **grade asynchronous forum discussions** with a grounded model rather than a gut feeling. Use it when you have many discussion contributions to assess and want consistent, usable feedback.

## How it works

It's a **one-shot generator** based on the Community of Inquiry model. Paste the complete thread, your learning objectives, and (optionally) your criteria; you get a diagnosis across three forms of presence — social, cognitive, and teaching — with strengths, improvements, and recommendations.
